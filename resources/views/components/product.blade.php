<form action="cart/add" method="post" class="variants product-action" data-cart-form data-id="product-actions-31449433"
    ...
    <div class="product-thumbnail">
        ...
        <div class="vendoritem"><img width="60" height="60" class="lazyload"
                src="assets/100/487/743/themes/912230/assets/lazy.png?1710378319730"
                data-src="assets/100/487/743/themes/912230/assets/vendorimg_2.jpg?1710378319730" alt="G-Shock">
        </div>
        ...
        <div class="action">
            ...
            <a title="Xem nhanh" href="g-shock-ga-1000-1adr-nam-quartz-pin-day-cao-su"
                data-handle="g-shock-ga-1000-1adr-nam-quartz-pin-day-cao-su" class="quick-view btn-views">
            ...
            <a href="javascript:void(0)" class="setWishlist btn-wishlist btn-views"
                data-wish="g-shock-ga-1000-1adr-nam-quartz-pin-day-cao-su" tabindex="0" title="Thêm vào yêu thích">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    <path fill="#ffffff"
    ...
    <div class="product-info">
        <h3 class="product-name">
            <a class="line-clamp line-clamp-2" href="g-shock-ga-1000-1adr-nam-quartz-pin-day-cao-su"
                title="G-SHOCK GA-1000-1ADR – NAM – QUARTZ (PIN) – DÂY CAO SU"> {{ $product->name }}</a>
        </h3>
    
        <div class="price-box">
            @if ($product->pricesale)
                <span class="new-price">{{ $product->pricesale }} ₫</span>
                <span class="old-price text-secondary" style="font-size: 12px;"><del>{{ $product->price }} ₫</del></span>
