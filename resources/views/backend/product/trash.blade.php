                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item waves-effect"
                                                        href="{{ route('admin.product.destroy', ['id' => $products->id]) }}">
                                                        <i class="mdi mdi-trash-can-outline me-1"></i> Destroy
                                                    </a>
                                                    <a class="dropdown-item waves-effect"
                                                        href="{{ route('admin.product.restore', ['id' => $products->id]) }}">
        ...
        <script>
            ...
            function submitBulkAction(action) {
                ...
                if (action === 'bulk-delete') {
                    form.action = '{{ route('admin.product.bulkDelete') }}';
                } else if (action === 'bulk-restore') {
                    form.action = '{{ route('admin.product.bulkRestore') }}';
                }
                form.submit();
            }
        </script>
